...
asv_key_file = os.path.join(truth_dir, '/home/swj1271/ADDMIBM/LA-keys-stage-1/keys/ASV/trial_metadata.txt')
asv_scr_file = os.path.join(truth_dir, '/home/swj1271/ADDMIBM/LA-keys-stage-1/keys/ASV/ASVTorch_Kaldi/score.txt')
cm_key_file = os.path.join(truth_dir, '/home/swj1271/ADDMIBM/LA-keys-stage-1/keys/CM/trial_metadata.txt')
